    ...
    function($class) {
        ...
        if ($classes === null) {
            $classes = array(
                ...
                'spriebsch\\eventstore\\eventsourceddecisiontrait' => '/decision/EventSourcedDecisionTrait.php',
                'spriebsch\\eventstore\\eventsourcedreadmodeltrait' => '/readModel/EventSourcedReadModelTrait.php',
